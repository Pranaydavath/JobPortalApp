					...
					<form action="handleForm" method="post">
						<div class="mb-1">
							...
							<input type="text" class="form-control" id="jobId"
								   name="jobId" required>  </div>

						<div class="mb-1">
							<label for="jobTitle" class="form-label">Job Profile</label>
							<input type="text" class="form-control" id="jobTitle"
								   name="jobTitle" required> </div>
						...
						<div class="mb-1">
							...
							<input type="number" class="form-control" id="reqExperience"
								   name="reqExperience" required> </div>

						<div class="mb-2">
							<label for="jobTechStack" class="form-label">Tech Stack</label>
							<select multiple class="form-select" id="jobTechStack" name="jobTechStack" required>
