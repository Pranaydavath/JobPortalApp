<%@ page language="java" contentType="text/html; charset=UTF-8"
         pageEncoding="UTF-8"%>
<%@ page import="com.pranay.JobApp.model.JobPost" %>
    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card border-dark bg-dark text-white">
                <div class="card-body">
                    <h5 class="card-title"><%= myJobPost.getJobTitle() %></h5>
                    <p class="card-text">
                        <strong>Description:</strong>
                        <%= myJobPost.getJobDescription() %>
                    </p>
                    <p class="card-text">
                    ...
                    <ul>
                        <% for (String tech : myJobPost.getJobTechStack()) { %>
                        <li><%= tech %></li>
                        <% } %>
                    </ul>
                    </p>
